...
const items = [
  { icon: Ruler, title: "Planned Layout", text: "Design cable routes, termination points and rack locations around your workspace and future requirements.", image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1400&q=85" },
  { icon: Cable, title: "Structured Connectivity", text: "Create consistent connections between switches, servers, workstations, access points and other network devices.", image: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?auto=format&fit=crop&w=1400&q=85" },
  { icon: Layers3, title: "Scalable Infrastructure", text: "Leave room for additional users, devices and locations without rebuilding the entire physical network.", image: "https://images.unsplash.com/photo-1563770660941-20978e870e26?auto=format&fit=crop&w=1400&q=85" },
  { icon: Wrench, title: "Simpler Maintenance", text: "Organized labeling, routing and documentation make troubleshooting and upgrades easier.", image: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1400&q=85" },
];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-white font-[Inter,Arial,sans-serif] text-[#111111]">
      ...
      <SolutionHero
        ...
        accent="Protect the business."
        description="Protect business connectivity with layered network security designed around users, devices, applications and infrastructure."
      />

      {/* STRUCTURED CABLING — FULL-WIDTH STACK */}
